...
export const metadata: Metadata = {
  ...
  description:
    "Original paintings, limited editions, and wearable silk works by contemporary artist Nino Devdariani. Enter the Nino D Visual and Wearable Archive.",
  ...
  return (
    <div className="w-full flex flex-col bg-warm-ivory text-ink-black overflow-x-hidden">
      <h1 className="sr-only">
        Nino D — Paintings that leave the wall by Nino Devdariani
      </h1>
      ...
      <section className="w-full border-b border-stone-grey/20 bg-warm-ivory">
        ...
        <div className="flex flex-col md:hidden w-full px-6 py-12 gap-10">
          ...
          <div className="text-center flex flex-col items-center px-2">
            <div className="font-serif text-4xl tracking-[0.25em] uppercase text-ink-black mb-4">Nino D</div>
            ...
            <div className="flex flex-col gap-4 w-full">
              ...
              <Link
                href="/about"
                className="text-ink-black text-[11px] uppercase tracking-[0.2em] font-medium py-2 text-center border-b border-ink-black/20 w-fit mx-auto hover:border-deep-oxblood hover:text-deep-oxblood transition-colors duration-300"
              >
                Enter Nino&apos;s world
              </Link>
            </div>
        ...
        <div className="hidden md:grid grid-cols-10 gap-8 lg:gap-12 max-w-7xl mx-auto px-8 lg:px-12 py-16 lg:py-24 items-center min-h-[calc(100vh-80px)]">
          {/* Left Column (30%) */}
          <div className="col-span-3 relative w-full aspect-[3/4] overflow-hidden safari-clip-fix bg-paper-grey group">
            <Image
              src="/images/homepage/hero/hero-left.jpg"
              alt="Painting detail by Nino Devdariani"
              fill
          ...
          <div className="col-span-4 bg-warm-ivory text-center flex flex-col items-center px-4 lg:px-8">
            ...
            <div className="font-serif text-5xl lg:text-6xl tracking-[0.25em] uppercase text-ink-black mb-6">Nino D</div>
            ...
            <div className="flex flex-col gap-4 w-full max-w-xs items-center">
              ...
              <Link
                href="/about"
                className="text-ink-black text-[10px] uppercase tracking-[0.2em] font-medium py-2 text-center border-b border-ink-black/20 hover:border-deep-oxblood hover:text-deep-oxblood transition-colors duration-300"
              >
                Enter Nino&apos;s world
              </Link>
            </div>
      ...
      <section className="w-full py-20 md:py-32 px-6 md:px-12 border-b border-stone-grey/20 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16 items-center">
          ...
          {/* Right Large Image */}
          <div className="col-span-1 md:col-span-7 relative w-full aspect-[4/3] overflow-hidden safari-clip-fix bg-paper-grey group">
            <Image
      ...
      <section className="w-full py-20 md:py-32 px-6 md:px-12 border-b border-stone-grey/20 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16 items-center">
          ...
          <div className="col-span-1 md:col-span-5 space-y-6">
            ...
            <p className="text-xs text-stone-grey leading-relaxed tracking-wide">
              Selected works are released as limited editions with archive documentation, edition numbers, and certificates of authenticity. Every piece carries an archival signature stamp recording its provenance and its place within a permanently closed edition.
            </p>
            <div className="pt-4">
              <Link
                href="/#waitlist"
      ...
      {/* ==========================================
          SECTION 05 - WAITLIST (the one door)
          ========================================== */}
      <WaitlistSection
        kicker="Edition 01"
